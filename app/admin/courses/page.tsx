  ...
  return (
    <div className="mx-auto max-w-5xl p-6">
      <div className="mb-6 flex items-center justify-between gap-4">
        <div>
          <h1 className="font-[family-name:var(--font-display)] text-2xl font-medium text-[var(--color-navy)] dark:text-slate-100">Kelola Course</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">Daftar course yang tersedia di sistem.</p>
        </div>
        <Link
              ...
              <>
                <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                  <div className="min-w-0">
                    <h2 className="truncate font-medium text-[var(--color-navy)] dark:text-slate-100">{course.judul || "Tanpa judul"}</h2>
                    <p className="mt-1 line-clamp-2 text-sm text-gray-500 dark:text-slate-400">{course.deskripsi || "Tidak ada deskripsi."}</p>
                  </div>
