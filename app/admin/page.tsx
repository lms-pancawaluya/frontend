...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold text-gray-800 mb-6 animate-fade-in">Profil Saya</h1>

      <div className="bg-white border border-gray-200 rounded-xl p-6 animate-fade-in-delay-1">
