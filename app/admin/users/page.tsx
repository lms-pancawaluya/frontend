    ...
    <div className="max-w-5xl mx-auto p-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-slate-400">{t("Daftar guru dan pengajar terdaftar di sistem", "List of teachers and instructors registered in the system")}</p>
        </div>
        <Link
          href="/register-guru"
