...
export default function CourseFeedbackForm({
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-[var(--color-border-soft)] shadow-sm space-y-4">
      ...
      {cooldownActive && (
        <div className="p-3 bg-amber-50 border border-amber-200 text-amber-700 rounded-xl text-xs font-medium space-y-1">
      ...
      <form onSubmit={handleSubmitFeedback} className="space-y-3">
        <div>
          ...
          <textarea
            ...
            className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 placeholder:text-slate-400 focus:bg-white focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 outline-none transition resize-none disabled:opacity-60 disabled:cursor-not-allowed"
          />
        </div>
