  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-6 p-4 sm:p-6 lg:p-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500 dark:text-slate-400">Tinjau dan nilai pengajuan RTL dari guru binaan Anda.</p>
      </div>
      ...
      <div className="overflow-hidden rounded-2xl border border-[var(--color-border-soft)] bg-white shadow-sm dark:bg-slate-900">
        {loading ? (
          ...
          <div className="py-16 text-center">
            <p className="text-sm text-gray-500 dark:text-slate-400">Belum ada pengajuan RTL{filterStatus ? " untuk status ini" : ""}.</p>
          </div>
        ) : (
