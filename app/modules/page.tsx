...
const BADGE_COLORS: Record<string, string> = {
  cageur: "bg-emerald-100 text-emerald-800 border-emerald-200 dark:bg-emerald-950/40 dark:text-emerald-300 dark:border-emerald-800",
  bageur: "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-950/40 dark:text-blue-300 dark:border-blue-800",
  bener: "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-950/40 dark:text-amber-300 dark:border-amber-800",
  singer: "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-950/40 dark:text-purple-300 dark:border-purple-800",
  pinter: "bg-rose-100 text-rose-800 border-rose-200 dark:bg-rose-950/40 dark:text-rose-300 dark:border-rose-800",
  umum: "bg-slate-100 text-slate-800 border-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:border-slate-700",
};
  ...
  return (
    <div className="min-h-screen bg-slate-50/80 pb-20 pt-8 relative overflow-hidden dark:bg-slate-900/80">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200/80 shadow-sm dark:bg-slate-900 dark:border-slate-800">
          ...
          <div className="relative flex-1 max-w-xs">
            ...
            />
            <svg
              className="w-4 h-4 text-slate-400 absolute left-3 top-2.5 dark:text-slate-500"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white rounded-3xl h-64 animate-pulse p-6 border border-slate-200 dark:bg-slate-900 dark:border-slate-800" />
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {visibleCourses.map((course) => (
              <Link
                ...
                className="group bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden flex flex-col transition-all hover:border-emerald-400 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50 dark:bg-slate-900 dark:border-slate-800"
              >
                {/* Header Card Course */}
                <div className="p-6">
                  ...
                  <h2 className="font-bold text-slate-900 text-lg leading-snug dark:text-slate-100">{course.judul}</h2>
                  {course.deskripsi && (
